...
## Summary
- PR E turns the deployed smoke workflow from a temporary runner into a tracked read-only script.
- The runner verifies Access-authenticated API, bootstrap, usage summary, GUI assets, browser rendering, and Budget Board posture without calling write-path endpoints.
...
- The budget gate treats `hard_limited`, missing sampled hard constraints, missing telemetry, missing D1 rows-written activity, and high bottleneck/D1-write usage as failures.
