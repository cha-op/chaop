...
- Restart requests no longer report success by reusing a healthy listener that is not owned by the connector; the pending restart remains blocked until the unowned listener is stopped.
