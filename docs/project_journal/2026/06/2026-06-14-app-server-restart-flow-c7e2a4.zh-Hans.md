...
- 当 managed app-server 已经 degraded 且没有可停止的 child process 时，scheduled restart 现在会尊重 startup backoff，并且不会在 backoff window 内反复 bump instance generation 或 control-plane reports。
