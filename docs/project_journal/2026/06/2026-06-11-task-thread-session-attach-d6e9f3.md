...
- Post-merge hardening adds a neutral Browser notice for successful history backfill results, including imported event counts, empty backfills, and bounded truncation, while keeping failed backfills as warnings.
