# Codex App-Server Control Plane Source Note [ British English | 简体中文 ]

## British English

This file is a source design note, not the final user-facing guide. User-facing documentation should use the bilingual document set, starting with `README.md`, `docs/deployment-guide.md`, `docs/ux-visual-directions.md`, `docs/PROJECT_STATE.md`, and `docs/PROJECT_TODO.md`.

## 简体中文

本文是来源设计笔记，不是最终面向用户的指南。面向用户的文档应使用双语文档集合，入口包括 `README.md`、`docs/deployment-guide.md`、`docs/ux-visual-directions.md`、`docs/PROJECT_STATE.md` 和 `docs/PROJECT_TODO.md`。
