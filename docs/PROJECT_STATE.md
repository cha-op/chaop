...
- Active workstream state lives in `docs/project_journal/2026/06/2026-06-11-thread-centre-realtime-c4d8a2.md`.
...
## Global Blockers
- Experimental Codex app-server protocol integration and R2 artefact capture are still deferred to later slices.
