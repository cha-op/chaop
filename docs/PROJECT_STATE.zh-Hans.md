...
- Deployed E2E smoke 现在也有已跟踪的只读 runner：`scripts/deployed-smoke.mjs`，并带有 Budget Board gates，检查 Cloudflare telemetry、sampled hard constraints、D1 rows-written 实测 activity、hard-limit posture 和高 usage thresholds。
