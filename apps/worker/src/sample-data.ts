...
export const budget: BudgetSummary = {
  ...
  d1_write_model: {
    ...
    free_worker_requests_per_day: 100000,
      budgeted_rows_written_per_event: 20,
      daily_budget_units: 5000,
      four_hour_soft_budget_units: 625,
      four_hour_hard_budget_units: 833,
      burst_budget_units: 500,
  ...
  constraints: [
    ...
    },
    {
      ...
      used_units: 10320,
      used_pct: 62,
      remaining_units: 6340,
      remaining_ratio: 0.38,
      per_event_units: 20,
      remaining_event_capacity: 317,
    ...
    },
    {
      ...
      used_units: 1800,
      used_pct: 18,
      remaining_units: 8200,
      remaining_ratio: 0.82,
      per_event_units: 20,
      remaining_event_capacity: 410,
  ...
  windows: [
    ...
    },
    {
      ...
      estimated_d1_rows_written: 10320,
      updated_at: "2026-06-09T21:58:05.000Z"
    },
    {
      window_type: "burst",
